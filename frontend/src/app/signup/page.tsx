...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-600 via-primary-700 to-primary-900 flex items-center justify-center px-4 py-12">
          ...
          {step === "register" ? (
            ...
            <form onSubmit={handleVerifyOtp} className="space-y-6">
              ...
              <button
                ...
                disabled={loading}
                className="w-full text-primary-600 hover:text-primary-700 font-medium text-sm disabled:opacity-50"
              >
                Renvoyer le code
              </button>
            </form>
