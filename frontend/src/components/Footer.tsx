...
export default function Footer() {
  return (
    <footer className="bg-gray-800 dark:bg-gray-950 text-white mt-12 md:mt-16">
      <div className="container mx-auto px-4 py-8 md:py-12">
        <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
          <div className="sm:col-span-2 md:col-span-1">
            <h3 className="text-lg md:text-xl font-bold mb-3 md:mb-4">FitApp</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs sm:text-sm text-gray-400 dark:text-gray-500">
              <li>
          ...
          <div>
            <h4 className="font-semibold mb-3 md:mb-4 text-sm md:text-base">Ressources</h4>
            <ul className="space-y-2 text-xs sm:text-sm text-gray-400 dark:text-gray-500">
              <li>
        ...
        <div className="border-t border-gray-700 dark:border-gray-800 mt-6 md:mt-8 pt-6 md:pt-8 text-center text-xs sm:text-sm text-gray-400 dark:text-gray-500">
